...
class AuthController extends Controller
{
    ...
    /**
     * ⚠️ SOLO PARA PRUEBAS. El enunciado no pide registro público
     * (los usuarios son personal administrativo, no se auto-registran).
     * Quita este método y su ruta antes de entregar.
     */
    ...
    /**
     * ⚠️ SOLO PARA PRUEBAS. Ver nota de showRegisterForm().
     */
